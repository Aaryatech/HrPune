...
public class SaveLeaveTrail {
    ...
    public SaveLeaveTrail(int trailPkey, int leaveId, int empId, String empRemarks, int leaveStatus, int makerUserId, String makerEnterDatetime) {
